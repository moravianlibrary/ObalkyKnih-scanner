...
begin
  ...
  begin
    MsgBox('Nepodporovaný OS:' #13#13 
        'Tato verze je funkèní jen na Windows XP a vyšších OS.',
  ...
  begin
    MsgBox('Chybí knihovna WIA 2.0 (' + ExpandConstant('{sys}\wiaaut.dll)') + #13#13
     'Kontaktujte administrátora pro instalaci balíèku z následující adresy:'#13#13
